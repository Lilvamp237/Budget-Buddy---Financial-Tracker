 ...
 * @author senud
 */
public class AddIncome5 extends javax.swing.JFrame {
    ...
    public AddIncome5(String uname) {
        this.uname = uname;
        initComponents();
    }

    public AddIncome5(User user) {
        this.user = user;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddIncome5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddIncome5().setVisible(true);
            }
        });
    }
