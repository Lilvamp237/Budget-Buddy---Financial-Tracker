 ...
 * @author senud
 */
public class OverviewExpense extends javax.swing.JFrame {

    private User user;
    private ExpenseTransaction expenses;

    /**
     * Creates new form Frame3
     */
    
    public OverviewExpense() {
        initComponents();
        getContentPane().setBackground(new Color(255, 255, 255));
        pieChart1.setChartType(PieChart.PeiChartType.DONUT_CHART);
        pieChart1.addData(new ModelPieChart("Shopping", 600, new Color(23, 126, 238)));
        pieChart1.addData(new ModelPieChart("Utilies", 300, new Color(221, 65, 65)));
        pieChart1.addData(new ModelPieChart("Other", 100, new Color(47, 157, 64)));
        pieChart1.addData(new ModelPieChart("Groceries", 600, new Color(196, 151, 58)));
    }

    public OverviewExpense(User user) {
        this.user = user;
        expenses = new ExpenseTransaction(user);
        String[] values = expenses.getCategory();
        float floatValue = 0;
        ...
        getContentPane().setBackground(new Color(255, 255, 255));
        pieChart1.setChartType(PieChart.PeiChartType.DONUT_CHART);
        pieChart1.addData(new ModelPieChart("Shopping", floatValues[0], new Color(23, 126, 238)));
        pieChart1.addData(new ModelPieChart("Utilies", floatValues[1], new Color(221, 65, 65)));
        pieChart1.addData(new ModelPieChart("Other", floatValues[2], new Color(47, 157, 64)));
        pieChart1.addData(new ModelPieChart("Groceries", floatValues[3], new Color(196, 151, 58)));
    }
    ...
    private void initComponents() {
        ...
        incomeClickLabel.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        incomeClickLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                incomeClickLabelMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                incomeClickLabelMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                incomeClickLabelMouseExited(evt);
            }
        });
        ...
        expensesClickLabel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        expensesClickLabel.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel3.setText("Expenses Breakdown");
        pieChart1.add(jLabel3, new AbsoluteConstraints(-24, 330, 510, -1));
        ...
        jLabel2.setText(expenses.getTotalExpensesforCurrentMonth()+"");
    ...
    private void incomeClickLabelMouseClicked(java.awt.event.MouseEvent evt) {                                              
        this.dispose();
        OverviewIncome frame=new OverviewIncome (user);
        frame.setVisible(true);
    }                                             

    private void incomeClickLabelMouseEntered(java.awt.event.MouseEvent evt) {                                              
        jPanel9.setBackground(new java.awt.Color(0,204,204));
        jPanel8.setBackground(new java.awt.Color(255, 255, 255));
    }                                             

    private void incomeClickLabelMouseExited(java.awt.event.MouseEvent evt) {                                             
        jPanel9.setBackground(new java.awt.Color(255, 255, 255));
        jPanel8.setBackground(new java.awt.Color(0,204,204));
    }                                            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OverviewExpense.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OverviewExpense().setVisible(true);
            }
        });
    }
